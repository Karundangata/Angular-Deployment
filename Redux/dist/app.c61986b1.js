...
var CREATE_POLICY = function CREATE_POLICY(name, amount) {
  return {
    type: 'CREATE_POLICY',
    payload: {
      name: name,
...
var DELETE_POLICY = function DELETE_POLICY(name, amount) {
  return {
    type: 'DELETE_POLICY',
    payload: {
      name: name,
...
var claims = function claims(listofClaim, action) {
  if (listofClaim === void 0) {
    listofClaim = [];
  }
  if (action.type === 'CREATE_CLAIM') {
    //return a new state-- pure fuctions 
    return __spreadArray(__spreadArray([], listofClaim, true), [action.payload.name], false);
  }
  return listofClaim;
};
...
var policies = function policies(listofPolies, action) {
  if (listofPolies === void 0) {
    listofPolies = [];
  }
  if (action.type === 'CREATE_POLICY') {
    return __spreadArray(__spreadArray([], listofPolies, true), [action.payload.name], false);
  }
  if (action.type === 'DELETE_POLICY') {
    return listofPolies.filter(function (name) {
